...
function customSet(arr) {
  ...
  for(const value of set) {
     if (typeof value === "number"){ delete set.delete(value);
      }
  }
...
function setToArray(mySet) {
  const arr = [...mySet];
  let strElem = arr.filter((element) => typeof element === "string");
  const sortElem = strElem.sort();
  return sortElem;
